...
public class Form1Kelurahan2 extends AppCompatActivity {
    ...
    Spinner spinner;
    String URL="http://koperasidev.dfiserver.com/apigw/reff/jabatan";
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                btnNext.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!jenisKlm.isEmpty() && !idKop.isEmpty() && !idKelembagaan.isEmpty() && !id_jabatan.isEmpty() &&  !nama.isEmpty() && !tlp.isEmpty() && !alamat.isEmpty() && !user.isEmpty() ){
                            // login user
                            ...
                            Toast.makeText(getApplicationContext(), "harap isi dengan benar : " + user ,  Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(Form1Kelurahan2.this,Form1Kelurahan1.class);
    ...
    private void checkUpload(final String jenisKlm, final String idKop, final String idKelembagaan, final String id_jabatan, final String nama, final String tlp, final String alamat, final String user) {
        ...
        String tag_string_req = "req_inputdata";
        pDialog.setMessage("Loading ...");
        showDialog();

        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_INPUT_PENGAWAS, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(jsonObject.getInt("success")==1) {
                        ...
                        ArrayAdapter<jabatan_profile> adapter = new ArrayAdapter<jabatan_profile>(Form1Kelurahan2.this, android.R.layout.simple_spinner_dropdown_item, jabatanList);
