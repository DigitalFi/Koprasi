        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!idUser.isEmpty() && !idPer.isEmpty() && !dtsp.isEmpty() && !bbsp.isEmpty() && !dtsw.isEmpty() && !bbsw.isEmpty() && !dtss.isEmpty() && !bbss.isEmpty() && !dtpu.isEmpty() && !bbpu.isEmpty() && !dthu.isEmpty() && !bbhu.isEmpty() && !dtcd.isEmpty() && !bbcd.isEmpty() && !dtshu.isEmpty() && !bbshu.isEmpty() && !etmasalah.isEmpty()){
                        // input data
                        uploadBitmap(bitmap, idUser, idPer, dtsp, bbsp, dtsw, bbsw, dtss, bbss, dtpu, bbpu, dthu, bbhu, dtcd, bbcd, dtshu, bbshu, etmasalah);
                        Toast.makeText(getApplicationContext(), "userId :" + idUser , Toast.LENGTH_LONG).show(); // display the current state for switch's
                    } else {
