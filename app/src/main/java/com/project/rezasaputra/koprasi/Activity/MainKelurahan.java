...
public class MainKelurahan extends AppCompatActivity
    ...
    public void input(View view) {
        Intent intent = new Intent(MainKelurahan.this, Form1Kelurahan.class);
        startActivity(intent);
    }

    public void history(View view) {
        Intent intent = new Intent(MainKelurahan.this, History_Kelurahan.class);
        startActivity(intent);
    }


    public void temuan(View view) {
