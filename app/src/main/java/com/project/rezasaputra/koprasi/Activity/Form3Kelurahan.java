...
public class Form3Kelurahan extends AppCompatActivity {
    ...
    String reffstatus="http://koperasidev.lavenderprograms.com/apigw/reff/status_kantor_temuan";
    String reffkgusaha="http://koperasidev.lavenderprograms.com/apigw/reff/jenis_usaha";
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(Form3Kelurahan.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (Form3Kelurahan.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Form3Kelurahan.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
    ...
    private void loadSpinnerDataStatus(String reffstatus) {
        // Tag biasanya digunakan ketika ingin membatalkan request volley
        String tag_string_req = "req_login";
        pDialog.setMessage("Get status koperasi . . . .");
        showDialog();
