...
public class history_data_kelurahan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_data_kelurahan);

        listnya = (ListView) findViewById(R.id.listview);
        ArrayAdapter<String> adapter;
        adapter = new ArrayAdapter<String>(history_data_kelurahan.this,android.R.layout.simple_list_item_1,
