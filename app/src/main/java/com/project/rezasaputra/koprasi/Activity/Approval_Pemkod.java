...
public class Approval_Pemkod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval__pemkod);
...
//                            "data kosong", Toast.LENGTH_LONG)
                ...
                //Toast.makeText(Approval_Pemkod.this, "Id Koperasi: "+idkel.getString("id", null), Toast.LENGTH_SHORT).show();
    ...
    private void checkfunction(final String user, final String idKop, final String status) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_POST_PRO_PEM, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if (!error) {
                        ...
                        if (status == "3") {
                            Intent intent = new Intent(Approval_Pemkod.this,
                                    MainPemkod.class);
    ...
    private void loadSpinnerData() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, AppConfig.URL_GET_LIST_PEM, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(jsonObject.getInt("success")==1) {
                        ...
                        ArrayAdapter<list_approvalkec> adapter = new ArrayAdapter<list_approvalkec>(Approval_Pemkod.this, android.R.layout.simple_spinner_dropdown_item, koperasiList);
