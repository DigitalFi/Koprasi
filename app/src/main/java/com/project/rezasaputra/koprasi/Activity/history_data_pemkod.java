...
public class history_data_pemkod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_data_pemkod);

        listnya = (ListView) findViewById(R.id.listview);
        ArrayAdapter<String> adapter;
        adapter = new ArrayAdapter<String>(history_data_pemkod.this,android.R.layout.simple_list_item_1,
